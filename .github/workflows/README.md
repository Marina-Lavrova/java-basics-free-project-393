...
Утилита для генерации и проверки надёжности паролей Лавровой Марины.
...
| `seed` | long | Ключ генератора (одинаковый seed даёт одинаковый пароль) |
...
- **Один балл за признак:** даже несколько цифр в пароле дают только один балл за "наличие цифры"